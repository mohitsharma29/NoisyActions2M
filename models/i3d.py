...
# Taken from https://github.com/tomrunia/PyTorchConv3D/blob/master/models/i3d.py
...
class InceptionI3D(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True, final_endpoint='logits',
        ...
        end_point = 'AvgPool_5'
        # Making first change here
        #self.layers[end_point] = nn.AvgPool3d(kernel_size=[8, 7, 7], stride=(1, 1, 1))
        self.layers[end_point] = nn.AvgPool3d(kernel_size=[2, 2, 4], stride=(1, 1, 1))
