...
=======
>>>>>>> d6eb0f86e794a41f701c69376fb294b933c2d346
...
DATASET_GETTERS = {'ucf101': get_ucf101, 'hmdb51': get_hmdb51}
...
=======
    parser.add_argument('--pretrain_path', default=None, type=str,
                        help='path of checkpoint to finetune')
    parser.add_argument('--n_finetune_classes', default=101, type=int,
                        help='Fine tune networks with this class number')
    ...
    """def create_model(args):
        ...
        if args.arch == 'resnet3D18':
            ...
            model = models.r2plus1d_18(num_classes=args.num_class)
...
=======
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # Change made: Validate after every epoch and starting 10 epochs, taking care of the fact that the best model gets stored
